    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            if args[0].lower() == "help":
             ...
             update.effective_message.reply_text("{}".format(PM_START_TEXT),reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text=" Add me to a Group ",url="t.me/{}?startgroup=true".format(bot.username))]]))            
